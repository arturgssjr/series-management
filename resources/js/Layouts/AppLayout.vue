            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :active="route().current('movies.index')" :href="route('movies.index')">
                            Movies
                        </jet-responsive-nav-link>
                        <jet-responsive-nav-link :active="route().current('series.index')" :href="route('series.index')">
                            Series
                        </jet-responsive-nav-link>
                    </div>
